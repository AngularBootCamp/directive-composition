# Angular Boot Camp example: directive-composition
...
**[StackBlitz for directive-composition](https://stackblitz.io/github/AngularBootCamp/directive-composition)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/directive-composition.git
cd directive-composition
npm install
npm start
```
